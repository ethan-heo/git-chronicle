...
type WebviewToExtensionMessage =
  ...
  | { type: 'FETCH_BRANCHES'; payload?: { refresh?: boolean } }
...
type ExtensionToWebviewMessage =
  ...
  | { type: 'BRANCHES_LOADED'; payload: { branches: Branch[]; refresh: boolean } }
  | { type: 'BRANCHES_LOAD_FAILED'; payload: { message: string; refresh: boolean } }
