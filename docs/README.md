...
| 파일 | 설명 |
|------|------|
| [git_author_explorer_기획서.md](git_author_explorer_기획서.md) | 최초 기획 원문. 배경, 목표, 전체 기능 범위 |
...
| [project/coding_standards.md](project/coding_standards.md) | TypeScript·React 코딩 컨벤션 |
