...
export const RegenerateButton: FC<RegenerateButtonProps> = ({ disabled, onClick }) => {
  ...
  return (
    <button
      className="inline-flex size-8 shrink-0 items-center justify-center rounded-md border border-line bg-secondary text-text transition-colors duration-100 ease-in-out hover:bg-secondary-hi disabled:cursor-not-allowed disabled:opacity-50"
      type="button"
