...
const DEFAULT_COMMIT_LIST_SECTION_HEIGHT = 240;
const DEFAULT_FILE_TREE_SECTION_HEIGHT = 220;
const DEFAULT_BRANCHES_SECTION_HEIGHT = 140;
const DEFAULT_NOTES_SECTION_HEIGHT = 180;
